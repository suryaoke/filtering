            ...
            <form id="main-form">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-12">
                        ...
                        <select id="customer_id" name="customer_id" class="form-select" style="width: 100%;">
                    ...
                    <div class="col-span-12">
                        ...
                        <select id="product_id" name="product_id" class="form-select" style="width: 100%;" required>
