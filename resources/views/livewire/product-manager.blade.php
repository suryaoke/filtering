<div>
    ...
    <!-- Add/Edit Modal -->
    <div id="livewire-modal" class="modal" tabindex="-1" aria-hidden="true" wire:ignore.self>
    ...
    <!-- Delete Modal -->
    <div id="livewire-delete-modal" class="modal" tabindex="-1" aria-hidden="true" wire:ignore.self>
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <div class="px-5 pb-8 text-center">
                        <button type="button" wire:click="$set('isDeleteOpen', false)" data-tw-dismiss="modal" class="btn btn-outline-secondary w-24 mr-1">Cancel</button>
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            Livewire.on('open-modal', () => {
                const el = document.querySelector("#livewire-modal");
            ...
            Livewire.on('open-delete-modal', () => {
                const el = document.querySelector("#livewire-delete-modal");
                tailwind.Modal.getOrCreateInstance(el).show();
            });
